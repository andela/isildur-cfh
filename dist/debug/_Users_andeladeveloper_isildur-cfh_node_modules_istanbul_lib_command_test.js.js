...
{
    var isProbablyChainable = function isProbablyChainable(obj, id) {
        return obj && obj.__instrumented_miss[id] !== undefined && 'number' === typeof obj.length;
    };
    ...
    __statement_chRfxK = function __statement_chRfxK(i) {
        var fd = store.register('/Users/andeladeveloper/isildur-cfh/node_modules/istanbul/lib/command/test.js');
        fs.writeSync(fd, '{"statement": {"node": ' + i + '}},\n');
    };

    __expression_EAm7zz = function __expression_EAm7zz(i) {
        var fd = store.register('/Users/andeladeveloper/isildur-cfh/node_modules/istanbul/lib/command/test.js');
        fs.writeSync(fd, '{"expression": {"node": ' + i + '}},\n');
    };

    __block_$hHVwQ = function __block_$hHVwQ(i) {
        var fd = store.register('/Users/andeladeveloper/isildur-cfh/node_modules/istanbul/lib/command/test.js');
        fs.writeSync(fd, '{"block": ' + i + '},\n');
    };
    __intro_wb1vlw = function __intro_wb1vlw(id, obj) {
        // console.log('__intro: ', id, ', obj.__instrumented_miss: ', obj.__instrumented_miss, ', obj.length: ', obj.length);
        ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object' || typeof obj === 'function') && Object.defineProperty && Object.defineProperty(obj, '__instrumented_miss', { enumerable: false, writable: true });
    ...
    __extro_AHsMH1 = function __extro_AHsMH1(id, obj) {
        var fd = store.register('/Users/andeladeveloper/isildur-cfh/node_modules/istanbul/lib/command/test.js');
...
// Instrumented Code
{
    ...
    var runWithCover = (__expression_EAm7zz(1), require('./common/run-with-cover')),
        util = (__expression_EAm7zz(2), require('util')),
        Command = (__expression_EAm7zz(3), require('./index'));
}
